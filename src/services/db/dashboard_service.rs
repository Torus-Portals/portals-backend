...
use crate::graphql::schema::dashboard::NewDashboard;
...
pub async fn create_dashboard(pool: impl PgExecutor<'_>, auth0_id: &str, new_dashboard: DBNewDashboard) -> Result<DBDashboard> {
  sqlx::query_as!(
    DBDashboard,
    r#"
